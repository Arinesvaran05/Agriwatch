<?php
// Simple admin user fix script - no external dependencies
...
echo ".code{background:#2c3e50;color:#ecf0f1;padding:15px;border-radius:5px;font-family:monospace;}";
echo "</style></head><body>";
echo "<div class='container'>";

echo "<h1>🔧 Fix Admin User - Direct Method</h1>";
...
echo "<h3>🔧 Alternative Method (if URLs still don't work)</h3>";
echo "<p>If you still can't access the URLs, try this:</p>";
echo "<ol>";
echo "<li>Open XAMPP Control Panel</li>";
echo "<li>Click 'Explorer' button</li>";
echo "<li>Navigate to: <span class='code'>C:\\xampp\\htdocs</span></li>";
echo "<li>Copy your entire AgriWatch folder there</li>";
echo "<li>Then try: <span class='code'>http://localhost/agriwatch/fix-admin.php</span></li>";
echo "</ol>";
