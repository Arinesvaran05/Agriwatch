...
if(!empty($data->email) && !empty($data->password)) {
    ...
    // Prepare query - only allow admins
    $query = "SELECT id, name, email, password, role, is_email_verified, created_at FROM users WHERE email = :email AND role = 'admin' LIMIT 1";
