        ...
        <div class="modal-content">
          ...
          <form [formGroup]="editUserForm" (ngSubmit)="updateUser()" class="form">
            <div class="form-group">
              <label>Name</label>
              <input type="text" formControlName="name" placeholder="Enter user name" 
                     [class.changed]="editUserForm.get('name')?.value !== selectedUser?.name">
              <div class="error" *ngIf="editUserForm.get('name')?.invalid && editUserForm.get('name')?.touched">
                Name is required
              </div>
              <div class="changed-indicator" *ngIf="editUserForm.get('name')?.value !== selectedUser?.name">
                ✓ Changed from "{{ selectedUser?.name }}"
              </div>
            </div>
            <div class="form-group">
              <label>Email</label>
              <input type="email" formControlName="email" placeholder="Enter user email"
                     [class.changed]="editUserForm.get('email')?.value !== selectedUser?.email">
              <div class="error" *ngIf="editUserForm.get('email')?.invalid && editUserForm.get('email')?.touched">
                Valid email is required
              </div>
              <div class="changed-indicator" *ngIf="editUserForm.get('email')?.value !== selectedUser?.email">
                ✓ Changed from "{{ selectedUser?.email }}"
              </div>
            </div>
            <div class="form-group">
              <label>Role</label>
              <select formControlName="role" [class.changed]="editUserForm.get('role')?.value !== selectedUser?.role">
                <option value="user">User</option>
                <option value="admin">Admin</option>
              </select>
              <div class="changed-indicator" *ngIf="editUserForm.get('role')?.value !== selectedUser?.role">
                ✓ Changed from "{{ selectedUser?.role }}"
              </div>
            </div>
            ...
            <div class="changes-summary" *ngIf="hasChanges()">
              ...
              <ul>
                <li *ngIf="editUserForm.get('name')?.value !== selectedUser?.name">
                  Name: "{{ selectedUser?.name }}" → "{{ editUserForm.get('name')?.value }}"
                </li>
                <li *ngIf="editUserForm.get('email')?.value !== selectedUser?.email">
                  Email: "{{ selectedUser?.email }}" → "{{ editUserForm.get('email')?.value }}"
                </li>
                <li *ngIf="editUserForm.get('role')?.value !== selectedUser?.role">
            ...
            <div class="form-actions">
              ...
              <button type="submit" [disabled]="editUserForm.invalid || isLoading || !hasChanges()" class="submit-btn">
